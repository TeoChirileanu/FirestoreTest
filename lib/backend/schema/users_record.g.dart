    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'phone_number':
          ...
          break;
        case 'guess':
          result.guess = serializers.deserialize(value,
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  int _guess;
  int get guess => _$this._guess;
  set guess(int guess) => _$this._guess = guess;

  int _correct;
  int get correct => _$this._correct;
  set correct(int correct) => _$this._correct = correct;
